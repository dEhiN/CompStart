...
Parent folder to hold all child folders related to any code, library, or tool experimentation for possible future use.

The need for this folder came out of the following:

...
do {
    ...
    if (($UserPrompt -eq "Y") -or ($UserPrompt -eq "y")) {
        ...
        $DealerFXTicketURLs = [string]$DealerFXTicketTabs
        ...
        Start-Process -FilePath "C:\Program Files\Google\Chrome\Application\chrome.exe" -ArgumentList "--profile-directory=Default","--new-window",$DealerFXTicketURLs

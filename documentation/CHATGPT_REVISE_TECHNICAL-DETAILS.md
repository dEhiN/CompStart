...
This document provides an overview of the main components of CompStart and how they work together.
...
The startup process consists of a Batch file and a PowerShell script.
...
The two main parts of CompStart interact through the JSON configuration:
...
```text
             ...
             │                           │
             ▼                           ▼
      Startup Process              Python CLI
             │                           │
      CompStart.ps1              CompStart.exe
             │                           │
             ▼                           ▼
     Launches startup items      Modifies configuration
```

The Batch file provides the Windows startup entry point for the PowerShell process, while the Python CLI provides a separate way to manage the configuration used by that process.

...
1. Start the full release process
2. Set up the release folder structure
3. Generate the Python executable
4. Copy the contents needed for a release over to the release folder
